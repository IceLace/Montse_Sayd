...
const PRELOAD_ASSETS = [
  ...
  assetUrl('assets/location/map-ceremony-watermark-square.png'),
  assetUrl('assets/location/map-reception-watermark-square.png'),
  assetUrl('assets/location/ceremony-cross.svg'),
  assetUrl('assets/location/reception-ornament.svg'),
  assetUrl('assets/location/venue-divider.svg'),
  assetUrl('assets/location/bottom-flourish.svg'),
  assetUrl('assets/location/ceremony-venue.webp'),
  assetUrl('assets/location/reception-venue.webp'),
